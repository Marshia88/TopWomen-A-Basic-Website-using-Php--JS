...
//       die();  //break the code here
      ...
      {
         //upload image
         //to upload img, we need img name, source path and dest path
    ...
    //3. execute query and save data in database. if query executed, res is true, else false
    
//     $res=mysqli_query($conn, $stmt);
    $res = $conn->query($stmt);

    //4. To check whether data is inserted or not 
    if($res== TRUE)
    {
