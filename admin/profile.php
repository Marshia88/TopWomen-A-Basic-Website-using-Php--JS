...
<!-- Menu section starts here -->
    <div class= "menu menu-center">
        <div class= "wrapup">
            <h3 id="nothing" style="color: white; font-family:Josefin Sans;">TopWomen</h3>
            <ul>
               ...
               <?php
					...
					if($count>0)
					{
				      while($rows= mysqli_fetch_assoc($res))  
				      {
					     ?>
    <div class="py-5">
        <h2 style="color: darkblue; font-family:Josefin Sans;" class="text-center">Hi! My name is <?php echo $rows['name'] ?>.</h2>
        <br>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                ...
                <h4 class="py-3"><p style= "font-family:Josefin Sans; color: black">Contact:</p></h4>
						<h5><p style= "font-family:Josefin Sans;"><?php echo $rows['email'] ?>Email:</p></h5>
						<h5><p style= "font-family:Josefin Sans;"><?php echo $rows['socialmedia'] ?></p></h5>
						<h5><p style= "font-family:Josefin Sans;"><?php echo $rows['linkedin'] ?></p></h5>
